...
# # Initialize Roboflow with your API key# Initialize Roboflow with your API key 
# rf = Roboflow(api_key="5EOf2OtYVbRTJEP0n7IE")                

# # Load your project and model
# project = rf.workspace().project("cinits")  # Replace with your project name
# model = project.version(2).model  # Replace with your

rf = Roboflow(api_key="5EOf2OtYVbRTJEP0n7IE")  
project = rf.workspace().project("gfryyh")  # Replace with your project name
...
def upload_image():
    ...
    try:
        ...
        count_file_path = os.path.join('static', 'tree_count_model_1.txt')
        with open(count_file_path, 'w') as file:
            file.write(f"Total tree count: {detected_trees}")
