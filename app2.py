...
# project = rf.workspace().project("reshpransanrutu")  # Replace with your project name
...
# # from roboflow import Roboflow
# # rf = Roboflow(api_key="9OgOlLVvRBxFKLFa3IfS")
# # project = rf.workspace("trees-tvzmk").project("reshpransanrutu")
...
#         file.write(f"Tree Count from Model 2: {detected_trees}")
...
rf = Roboflow(api_key="jeDmaylXjo95nzvxfx9e")

# Load your project and model
project = rf.workspace().project("sprauce")  # Replace with your project name
model = project.version(1).model  # Replace with your model version number
